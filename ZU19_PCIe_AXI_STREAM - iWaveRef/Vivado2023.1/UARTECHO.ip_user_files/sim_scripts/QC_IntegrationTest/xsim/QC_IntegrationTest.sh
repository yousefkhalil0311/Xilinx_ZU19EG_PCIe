...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L xdma_v4_1_23 -L axi_vip_v1_1_14 -L zynq_ultra_ps_e_vip_v1_0_14 -L xilinx_vip"
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb QC_IntegrationTest.wdb xsim.dir libdpi.so)
