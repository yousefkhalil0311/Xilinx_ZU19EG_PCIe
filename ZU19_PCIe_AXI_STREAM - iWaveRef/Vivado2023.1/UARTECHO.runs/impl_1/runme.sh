...
HD_PWD='C:/Xilinx/Projects/Xilinx_ZU19EG_PCIe/ZU19_PCIe_AXI_STREAM - iWaveRef/Vivado2023.1/UARTECHO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log QC_IntegrationTest_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source QC_IntegrationTest_wrapper.tcl -notrace
