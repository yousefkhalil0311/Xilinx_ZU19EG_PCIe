...
HD_PWD='C:/Xilinx/Projects/Xilinx_ZU19EG_PCIe/ZU19_PCIe_AXI_STREAM - iWaveRef/Vivado2023.1/UARTECHO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QC_IntegrationTest_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QC_IntegrationTest_wrapper.tcl
